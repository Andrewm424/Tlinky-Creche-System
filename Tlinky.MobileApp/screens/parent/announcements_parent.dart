...
class _ParentAnnouncementsScreenState
    extends State<ParentAnnouncementsScreen> {
  bool isLoading = true;
  String? error;
  ...
  Future<void> fetchAnnouncements() async {
    ...
    try {
      // ✅ Fetch announcements for Parents + Everyone
      final uri =
          Uri.parse('${ApiService.baseUrl}/AnnouncementsApi?audience=Parents');
